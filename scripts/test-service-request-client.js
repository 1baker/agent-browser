...
async function main() {
  ...
  const overriddenEvaluateRequest = createServiceEvaluateRequest({
    ...
    runtimeProfile: 'runtime-override',
  ...
  assert.deepEqual(
    {
      browserId: overriddenEvaluateRequest.browserId,
      sessionName: overriddenEvaluateRequest.sessionName,
      targetId: overriddenEvaluateRequest.targetId,
      runtimeProfile: overriddenEvaluateRequest.runtimeProfile,
      profileId: overriddenEvaluateRequest.profileId,
    },
    {
      browserId: 'session:override',
      sessionName: 'override-session',
