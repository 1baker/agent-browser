...
- **Fresh-host safety** - Added pre-mutation disk-capacity validation, one-sudo host preparation, protected helper verification, private generated credentials, source-free systemd units, idempotent payload materialization, and disposable Ubuntu reboot validation (#7).
