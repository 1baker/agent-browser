    ...
    json!({
        ...
        "contracts": {
            ...
            "serviceProfileAllocationResponse": {
                ...
                "mcp": {
                    "resourceTemplate": SERVICE_PROFILE_ALLOCATION_MCP_RESOURCE_TEMPLATE,
                },
                "client": {
                    "package": "@agent-browser/client/service-observability",
                    "helpers": ["getServiceProfileAllocation"],
                },
            },
            "serviceProfileReadinessResponse": {
                ...
                "mcp": {
                    "resourceTemplate": SERVICE_PROFILE_READINESS_MCP_RESOURCE_TEMPLATE,
                },
                "client": {
                    "package": "@agent-browser/client/service-observability",
            ...
            "serviceProfileSeedingHandoffResponse": {
                ...
                "mcp": {
                    ...
                    "resourceTemplate": SERVICE_PROFILE_SEEDING_HANDOFF_MCP_RESOURCE_TEMPLATE,
                },
            ...
            "serviceMonitorStateResponse": {
                ...
                "http": {
                    "routes": [
                        ...
                        {
                            "method": "POST",
                            "route": SERVICE_MONITOR_RESET_FAILURES_HTTP_ROUTE,
                        },
                    ],
                },
                "mcp": {
                    "tools": [
                        ...
                        SERVICE_MONITOR_RESET_FAILURES_MCP_TOOL_NAME,
                    ],
                },
                "client": {
                    "package": "@agent-browser/client/service-observability",
...
mod tests {
    ...
    fn service_request_contract_metadata_has_stable_ids() {
        ...
        assert_eq!(
            metadata["contracts"]["serviceProfileAllocationResponse"]["mcp"]["resourceTemplate"],
            SERVICE_PROFILE_ALLOCATION_MCP_RESOURCE_TEMPLATE
        );
        assert_eq!(
            metadata["contracts"]["serviceProfileAllocationResponse"]["client"]["helpers"][0],
        ...
        assert_eq!(
            metadata["contracts"]["serviceProfileReadinessResponse"]["mcp"]["resourceTemplate"],
            SERVICE_PROFILE_READINESS_MCP_RESOURCE_TEMPLATE
        );
        assert_eq!(
        ...
        assert_eq!(
            metadata["contracts"]["serviceMonitorStateResponse"]["mcp"]["tools"][2],
            SERVICE_MONITOR_RESET_FAILURES_MCP_TOOL_NAME
        );
        assert_eq!(
