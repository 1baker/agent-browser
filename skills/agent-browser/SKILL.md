...
route-pool setup, existing-user sync, and legacy autologin scripts call the
same guard before writing Guacamole records, write route records with
`ON_ERROR_STOP`, and force a checkpoint after those route writes.
