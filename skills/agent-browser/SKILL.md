...
versioned support manifest, dashboard service, runtime interlock, and
PostgreSQL backup units. Treat `ready: false` as a hard stop and do not activate
those units until the substrate-provisioning packet is complete.
